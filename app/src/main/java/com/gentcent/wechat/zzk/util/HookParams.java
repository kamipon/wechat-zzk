...
public class HookParams {
	...
	public static String model_aw = "com.tencent.mm.plugin.sns.model.aw";
	public static String model_aw_method = "t";
	public static String storage_o = "com.tencent.mm.plugin.sns.storage.o";
	public static String storage_o_method = "JW";
	public static String storage_n = "com.tencent.mm.plugin.sns.storage.n";
	public static String model_am_a = "com.tencent.mm.plugin.sns.model.am$a";
	public static String model_am_a_method = "WL";
	public static String protobuf_byg = "com.tencent.mm.protocal.protobuf.byg";
	public static String storage_h = "com.tencent.mm.plugin.sns.storage.h";
	public static String storage_v = "com.tencent.mm.plugin.sns.storage.v";
	public static String model_af = "com.tencent.mm.plugin.sns.model.af";
	public static String storage_i = "com.tencent.mm.plugin.sns.storage.i";
